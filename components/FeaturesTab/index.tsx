...
const FeaturesTab = () => {
  ...
  const getImageSrc = () => {
    switch (currentTab) {
      case "tabOne":
        return "/images/shape/shape-dotted-light.svg"; // Adjust the path if necessary
      case "tabTwo":
        return "/images/shape/shape-dotted-dark.svg"; // Adjust as needed for tabTwo
      case "tabThree":
        return "/images/shape/shape-dotted-light.svg"; // Adjust as needed for tabThree
      default:
        return "/images/shape/shape-dotted-light.svg"; // Fallback image
    }
  };
    ...
    <>
      ...
      <section className="relative pb-20 pt-18.5 lg:pb-22.5">
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="absolute -top-16 -z-1 mx-auto h-[350px] w-[90%] hidden md:block">
            <Image
              fill
          ...
          {/* Visible on small screens below the content */}
          <div className="relative mx-auto h-[350px] w-full md:hidden mt-8">
            <Image
              fill
