      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: ` Flexible Learning at Deutsch Connect Academy`,
              description: `Study from anywhere, anytime, at Deutsch Connect Academy—learn at your own pace and in your own way`,
            }}
          />
